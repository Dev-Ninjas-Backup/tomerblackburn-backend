...
export class BathroomTypeCostCodesController {
  constructor(private readonly bathroomTypeCostCodesService: BathroomTypeCostCodesService) {}

  @Post()
  create(@Body() createBathroomTypeCostCodeDto: CreateBathroomTypeCostCodeDto) {
    return this.bathroomTypeCostCodesService.create(createBathroomTypeCostCodeDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateBathroomTypeCostCodeDto: UpdateBathroomTypeCostCodeDto) {
    return this.bathroomTypeCostCodesService.update(+id, updateBathroomTypeCostCodeDto);
  }
